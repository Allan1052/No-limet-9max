...
describe("Etapa 2 - hierarquia dos controles", () => {
  test("separa acoes principais, tamanhos e controle de raise", () => {
    ...
    expect(controls).toContain('className="sizing-panel"');
  ...
  test("tem tratamento responsivo para celular em pe e deitado", () => {
    expect(css).toContain(".action-choice");
    expect(css).toContain(".action-choice-raise");
