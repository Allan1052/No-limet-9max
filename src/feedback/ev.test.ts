...
describe("EV em bb no feedback", () => {
  it("call lucrativo mostra EV positivo e guarda evBB", () => {
    const item = gradeDecision("Flop", "call", { ...base, evBB: 2.3 });
