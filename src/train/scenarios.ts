...
export function randomHand(rng: () => number, variant: "holdem" | "omaha" | "sng3" | "cash" = "holdem"): Card[] {
...
export function buildScenario(module: TrainModule, rng: () => number, variant: "holdem" | "omaha" | "sng3" | "cash" = "holdem"): Scenario {
