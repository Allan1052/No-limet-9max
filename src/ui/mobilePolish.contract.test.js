...
const tableCss = fs.readFileSync(new URL("./tableModern.css", import.meta.url), "utf8");
const controlsCss = fs.readFileSync(new URL("./controlsHierarchy.css", import.meta.url), "utf8");
const progressCss = fs.readFileSync(new URL("./sessionProgressStrip.css", import.meta.url), "utf8");
